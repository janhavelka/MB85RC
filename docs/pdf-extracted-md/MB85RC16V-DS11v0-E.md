# MB85RC16V-DS501-00010-11v0-E.pdf

- Source PDF: `MB85RC16V-DS11v0-E.pdf`
- Extraction tool: pdfplumber
- Page count: 36
- SHA256: `32dde057b2f4bc8636f07d215ce092c964b430a0da457affcecbb05cc3af050a`
...
MB85RC16V
 DESCRIPTION
The MB85RC16V is an FeRAM (Ferroelectric Random Access Memory) chip in a configuration of 2,048
...
which is a significant improvement over the number of read/write operations than by other nonvolatile memory
products.
...
• Operation ambient temperature range: - 40 degC to + 85 degC
...
5 SDA address and writing/reading data. It is possible to connect multiple devices. It is an
open drain output, so a pull-up resistor is required to be connected to the external
circuit.
Serial Clock pin
6 SCL This is a clock input pin for input/output serial data. Data is sampled on the rising
...
Master MB85RC16V Other slave

## Page 4

MB85RC16V
 I2C COMMUNICATION PROTOCOL
The I2C bus provides communication by two wires only, therefore, the SDA input should change while the
SCL is the “L” level. However, when starting and stopping the communication sequence, the SDA is allowed
...
Start At this time, the receiver side outputs a pull-down if the
previous 8 bits data are received correctly (ACK response).
4 DS501-00010-11v0-E
...
Device Type Code Memory Upper Read/Write Code
Address Code
Access from master
Access from slave
S Start Condition
A ACK (SDA is the "L" level)
DS501-00010-11v0-E 5
...
The MB85RC16V performs the high speed write operations, so any waiting time for an ACK* by the acknowl-
...
page write is performed. The memory address rolls over to first memory address (000 ) at the end of the
H
...
Address Read
S 1 0 1 0 A2 A1 A0 0 A A S 1 0 1 0 A2 A1 A0 1 A N P
Low 8bits Data 8bits
(Input example) when reading 001 01101111 001
B B B
memory address 16FH:
Access from master
Access from slave
...
VIN  VIL (Max) 50   k
Input resistance for WP pin RIN
VIN  VIH (Min) 1   M
*1: Applicable pin: SCL,SDA
*2: Applicable pin: SDA
DS501-00010-11v0-E 11
...
Input voltage amplitude: VDD x 0.2 to VDD x 0.8
Input rising time : 5 ns
Input falling time : 5 ns
Input judge level : VDD/2
Output judge level : VDD/2
12 DS501-00010-11v0-E
...
Min Typ Max
I/O capacitance CI/O VDD = VIN = VOUT = 0V,   15 pF
...
ESD CDM (Charged Device Model) MB85RC16VPNF-G-JNN1ERE1
>= |1000 V|
JESD22-C101 compliant MB85RC16VPNF-G-AWE2
...
quantity
8-pin, plastic SOP
MB85RC16VPNF-G-JNN1E1 Tube *1
(150mil)
8-pin, plastic SOP
MB85RC16VPNF-G-JNN1ERE1 Embossed Carrier tape 1500
(150mil)
8-pin, plastic SOP
MB85RC16VPNF-G-AWE2 Tube *1
(150mil)
8-pin, plastic SOP
MB85RC16VPNF-G-AWERE2 Embossed Carrier tape 1500
(150mil)
*1: Please contact our sales office about minimum shipping quantity.
DS501-00010-11v0-E 17

## Page 18

MB85RC16V
 PACKAGE DIMENSION
 (1)MB85RC16VPNF-G-JNN1E1/MB85RC16VPNF-G-JNN1ERE1
...
(cid:15910)(cid:41)(cid:51)(cid:55)(cid:16)(cid:27)(cid:51)(cid:16)(cid:48)(cid:20)(cid:21)(cid:12)
8pin 5pin
1pin 4pin
18 DS501-00010-11v0-E
)niM(50.0
Details of “A” part
*(cid:19)(cid:22)(cid:17)(cid:19)(cid:115)09.3
52.0(cid:15996)51.0
1.27 0.44±0.10
)xaM(57.1
...
MB85RC16V
(continued)
 (2)MB85RC16VPNF-G-AWE2/MB85RC16VPNF-G-AWERE2
8pin 5pin
1pin 4pin
DS501-00010-11v0-E 19
)niM(52.1
)niM(01.0
0.4(Min)
*(cid:20)(cid:17)(cid:19)(cid:115)09.3
4.90±0.1* 52.0(cid:15996)01.0
1.27 0.41±0.1
)xaM(57.1
(cid:21)(cid:17)(cid:19)(cid:115)(cid:19)(cid:17)(cid:25)
8-pin plastic SOP Lead pitch 1.27mm
Package width ×
3.90mm (cid:153) 4.90mm
package length
Lead shape Gullwing
Sealing method Plastic mold
Mounting heigth 1.75mm MA X
Note *: These dimensions do not include resin protrution.
8-pin plastic SOP Pins width not do ninclude tie bar cutting remaindar.
“A”
Details of “A” part
Dimenssions in mm
...
[8-pin plastic SOP]
RC16V : Product name
E11900 : E1(Lead free code) + 1190(Year and Week code)
300: Trace code
[MB85RC16VPNF-G-AWE2
[MB85RC16VPNF-G-AWERE2]
R C 1 6 V
...
[8-pin plastic SOP]
RC16V : Product name
11900 : 1(CS code) + 1190(Year and Week code)
R00: Trace code
20 DS501-00010-11v0-E
...
Maximum quantity
Package form
ICs/tube(520mm) ICs/inner box ICs/outer box
95 7,600 30,400
7.4
(Dimensions in mm)
• Direction of index of tube
DS501-00010-11v0-E 21
6.2
No heat resistance.
...
565 270 180
(Dimensions in mm)
DS501-00010-11v0-E 23

## Page 24

MB85RC16V
2. Emboss Tape (MB85RC16VPNF-G-JNN1ERE1)
2.1 Tape Dimensions
Maximum storage capacity
ICs/reel(=330mm) ICs/inner box ICs/outer box
1,500 10,500
1,500
...
415 400 315
(Dimensions in mm)
DS501-00010-11v0-E 27

## Page 28

MB85RC16V
(2)MB85RC16VPNF-G-AWE2/MB85RC16VPNF-G-AWERE2
1. Tube (MB85RC16VPNF-G-AWE2)
1.1 Tube Dimensions
• Tube/stopper shape (example)
Tube
Stopper
...
Maximum quantity
Package form
ICs/tube(509mm) ICs/inner box ICs/outer box
85 4,250 25,500
8.0
(Dimensions in mm)
• Direction of index of tube
28 DS501-00010-11v0-E
9.3
No heat resistance.
Package should not be baked by
using tube.
...
567 272 269
(Dimensions in mm)
30 DS501-00010-11v0-E

## Page 31

MB85RC16V
2. Emboss Tape (MB85RC16VPNF-G-AWERE2)
2.1 Tape Dimensions
Maximum storage capacity
ICs/reel(=330mm) ICs/inner box ICs/outer box
1,500 9,000
...
[MSL Label (100mm x 70mm)]
MSL label
DS501-00010-11v0-E 33
...
Following technical word is revised to more commonly used one.
 Overall
FRAM to FeRAM
DS501-00010-11v0-E 35
