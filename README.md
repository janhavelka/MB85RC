...
state, and active-transfer exclusivity, then return without I2C traffic.
...
Large reads and verifies use `cmd::MAX_READ_CHUNK`; writes use
`cmd::MAX_WRITE_CHUNK`; fills use a fixed 64-byte local buffer. Every chunk
